 ...
 * @author murilo.van
 */
public class SkyboardPrincipal extends javax.swing.JFrame {

    /**
     * Creates new form SkyboardPrincipal
     */
    public SkyboardPrincipal() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SkyboardPrincipal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SkyboardPrincipal().setVisible(true);
            }
        });
    }
